function [K,CL,g,info] = tvhinfsfb(G,Nu,varargin)
%% TVHINFFI  H-infinity State-Feedback Synthesis on a Finite Horizon.
%
% Same as H-infinity full-information control but here disturbances are not
% required in controller reconstruction.
