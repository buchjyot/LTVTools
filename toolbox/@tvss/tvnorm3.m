function [g,d,info] = tvnorm3(G,E0,varargin)
%% TVNORM computes the time varying system norm using RDE bisections only.
%
% In addition to normal bisection we check if P(0) <= g^2*E0 to ensure initial
% condition ellipsoid decribed by x(0)' E0 x(0) <= 1.
%
% Syntex:
%
