...
% SYSIC  SYSTEM interconnection for time-varying objects.
%
% SYSIC forms interconnections of time-varying systems. 
% Type "help robust\sysic" for details.
% 
%   % EXAMPLE: (CUT/PASTE)
...
switch class(a)
   case{'tvss' 'ss' 'tf' 'zpk' 'frd' 'genss' 'genfrd' 'genmat' 'realp'}
      b = a;
      flag = -2;
   case{'tvmat' 'umat' 'ufrd' 'uss' 'tvumat' 'tvuss'}
      b = a;
      flag = -1;
