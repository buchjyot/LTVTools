function [glb,dwc,info] = tvnormPower(G,NE,U1,x0,Opt)
%% TVPOWERIT
% Runs power iterations to estimate the best lower bound
%
% This is not a user facing function. This utility function runs power
% iterations for only LTV systems described by TVSS. Compared to the
% general function named "powerit", this function perform minimum possible
% switch case and/or if- else statements. Moreover, no error checking is
% done in this function. This function only works for TVSS objects.
%
